...
public class Main {
    public static void main(String[] args) {
        ...
        int i = 0;
        while(true){
            System.out.println("Limite do cartao: R$"+ cartao.getFatura());
            ...
            System.out.println("O produto "+ novoP.getDescricao()+" foi adicionado com sucesso, adicionando R$"+ novoP.getPreco()+" ao limite do cartão");
        }
    }
    }